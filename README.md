# Confusion Matrix Studio

> Studio for cost-sensitive confusion matrices

**Author:** zAx4hub

## Problem

Studio for cost-sensitive confusion matrices. Teams often rely on closed SaaS, brittle scripts, or untested prototypes for this niche.

## Solution

`confusion-matrix-studio` is an installable TypeScript/Node toolkit by **zAx4hub** with a real **parser** engine, CLI, examples, and tests.
